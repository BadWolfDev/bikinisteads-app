        ...
        <FooterContainer>
            ...
            {/*<FooterLinksContainer>
                ...
                <SocialMediaWrap>
                    ...
                    <SocialIcons>
                        <SocialIconLink onPointerOver={() => setHover(true)} onPointerOut={() => setHover(false)} href="https://twitter.com/home" target='_blank' aria-label='twitter' style={SocialColorT({hover})}>
                            <FaTwitter/>
                        </SocialIconLink>
